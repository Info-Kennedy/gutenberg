...
class BooksMobile extends StatefulWidget {
  final String categoryName;
  const BooksMobile({super.key, required this.categoryName});

  @override
  State<BooksMobile> createState() => _BooksMobileState();
}

class _BooksMobileState extends State<BooksMobile> {
